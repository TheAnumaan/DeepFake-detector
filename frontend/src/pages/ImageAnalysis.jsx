...
const ImageAnalysis = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:5002/api/analyze-image', formData, {
        headers: {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold mb-8 text-center">Image News Analyzer</h1>
      
      <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-md mb-8">
        <div className="mb-4">
          <label className="block text-gray-700 font-bold mb-2">Image File *</label>
          <input
            type="file"
        ...
        <button
          ...
          disabled={loading}
        >
          {loading ? 'Analyzing Image...' : 'Analyze Image Content'}
        </button>
