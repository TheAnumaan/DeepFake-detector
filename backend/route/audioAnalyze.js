...
router.post("/",upload.single("audioFile"),async (req,res) => {
    try {
        ...
        const analysisResultWithGroq = await analyzeWithGroq(title, transcription, source)
        const analysisResultsWithGemini = await analyzeWithGemini(title, transcription, source,analysisResultWithGroq);
        ...
        res.json({ success: true, article, analysis: analysisResultsWithGemini, transcription });
      } catch (error) {
